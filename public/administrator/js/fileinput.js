/**
 * Created by kurti on 12.08.2015.
 */
(function ($) {
    "use strict";
    ...
    var isIE = function (ver) {
        ...
        tFooter = '<div class="file-thumbnail-footer">\n' +
            '           <div class="file-footer-caption" title="{caption}" style="display:none">{caption}\n</div>' +
            '           <div class="form-group">' +
            '               <label clas="col-sm-2 control-label">Alt Metin</label>' +
            '               <div class="col-md-10">' +
            '                   <input type="text" name="alt[]" value="{caption}" class="form-control"/>' +
            '               </div>' +
            '           </div>\n' +
            '           <div class="form-group">' +
            '               <label clas="col-sm-2 control-label">Varsayılan</label>' +
            '               <div class="col-md-10">' +
            '                   <input type="checkbox" id="varsayilan" name="varsayilan[]" value="{caption}"/>' +
            '               </div>' +
            '           </div>\n' +
            '       </div>',
